...
SERVICE="personal-ai"
VARS="OPENCODE_ZEN_API_KEY TOGETHER_API_KEY GOOSE_SERVER__SECRET_KEY NTFY_TOPIC NTFY_EMAIL TAVILY_API_KEY GOOGLE_OAUTH_CLIENT_ID GOOGLE_OAUTH_CLIENT_SECRET"
ZSHRC="$HOME/.zshrc"
