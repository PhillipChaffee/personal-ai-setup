...
MAP_ENTRIES: Final[tuple[MapEntry, ...]] = (
    ...
    row(1, "AGENTS.md", "AGENTS.md",
        "how agents work in this repo: the tracker, the labels, the domain docs"),
    row(1, "CONTEXT.md", "CONTEXT.md",
        "the domain glossary: one term, one meaning, everywhere"),
    ...
    row(2, "agents/", "docs/agents",
        "{n} agent-skills config files: issue tracker, triage labels, domain-doc rules", "*.md"),
    row(2, "adr/", "docs/adr", "{n} decisions, numbered oldest first", "*.md"),
    ...
    row(2, "coding-agents.md", "docs/coding-agents.md",
    ...
    row(2, "troubleshooting.md", "docs/troubleshooting.md",
        "base_url 404s, pairing, LUKS, rate limits"),
    row(2, "roadmap.md", "docs/roadmap.md", "SearXNG, memory, budgeting-app API"),
    ...
    row(2, "herdr/config.toml", "config/herdr/config.toml",
        "the herdr server config template: six keys, every one explicit"),
